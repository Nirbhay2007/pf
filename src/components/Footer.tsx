      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center">
          <div className="mb-12">
            ...
            <p className="text-slate-600 dark:text-slate-300 max-w-2xl mx-auto text-lg font-['Inter'] leading-relaxed">
          ...
          <div className="border-t border-white/20 dark:border-slate-600/40 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center gap-6">
              <div className="flex items-center gap-3 text-slate-600 dark:text-slate-300 font-['Inter']">
                <span>Made with</span>
              ...
              <button
                onClick={scrollToTop}
                className="group p-3 modern-card hover:scale-110 transition-all duration-300 text-slate-600 dark:text-slate-300 hover:text-portfolio-primary dark:hover:text-portfolio-primary"
